...
for (r in 2:361){                                    # This calculates the survival in the next age based on the previous age using total moratlity from our fished population
...
setwd(sg_dir)
saveRDS(Starting.Pop.For.Model, file="Starting_Pop")
