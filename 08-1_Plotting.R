...
Dist.Names <- as.character(c("0-10km", "10-50km", "50-100km"))
...
S00.abundance.dist.plot <- ggplot()+
  ...
  scale_linetype_manual(values=c("50-100km"="dashed", "10-50km"="dotted", "0-10km" = "solid"), name="Distance from\nboat ramp")+
  ...
  geom_vline(xintercept=2005, colour="grey20")+
  geom_vline(xintercept=2017, linetype="dotted", colour="grey20")+
  ggplot2::annotate("text", x=1961, y=5000, label="(a)", size = 2.5, fontface=2, hjust=0)
...
S01.abundance.dist.plot <- ggplot()+
  ...
  geom_vline(xintercept=2005, colour="grey20")+
  geom_vline(xintercept=2017, linetype="dotted", colour="grey20")+
  ggplot2::annotate("text", x=1960.5, y=5200, label="(b)", size = 2.5, fontface=2, hjust=0)
...
S02.abundance.dist.plot <- ggplot()+
  ...
  scale_linetype_manual(values=c("50-100km"="dashed", "10-50km"="dotted", "0-10km" = "solid"), name="Distance to\nboat ramp")+
  ...
  geom_vline(xintercept=2005, colour="grey20")+
  geom_vline(xintercept=2017, linetype="dotted", colour="grey20")+
  ggplot2::annotate("text", x=1960.5, y=5200, label="(c)", size = 2.5, fontface=2, hjust=0)
...
S03.abundance.dist.plot <- ggplot()+
  ...
  scale_linetype_manual(values=c("50-100km"="dashed", "10-50km"="dotted", "0-10km" = "solid"))+
  ...
  geom_vline(xintercept=2005, colour="grey20")+
  geom_vline(xintercept=2017, linetype="dotted", colour="grey20")+
  ggplot2::annotate("text", x=1960.5, y=5200, label="(d)", size = 2.5, fontface=2, hjust=0)
...
S00.catch.dist.plot <- ggplot()+
  ...
  geom_vline(xintercept=2005, colour="grey20")+
  geom_vline(xintercept=2017, linetype="dotted", colour="grey20")+
  ggplot2::annotate("text", x=1961, y=350, label="(a)", size = 2.5, fontface=2, hjust=0)
S00.catch.dist.plot
...
S01.catch.dist.plot <- ggplot()+
  ...
  geom_vline(xintercept=2005, colour="grey20")+
  geom_vline(xintercept=2017, linetype="dotted", colour="grey20")+
  ggplot2::annotate("text", x=1961, y=220, label="(b)", size = 2.5, fontface=2, hjust=0)
S01.catch.dist.plot
...
S02.catch.dist.plot <- ggplot()+
  ...
  geom_vline(xintercept=2005, colour="grey20")+
  geom_vline(xintercept=2017, linetype="dotted", colour="grey20")+
  ggplot2::annotate("text", x=1961, y=350, label="(c)", size = 2.5, fontface=2, hjust=0)
S02.catch.dist.plot
...
S03.catch.dist.plot <- ggplot()+
  ...
  geom_vline(xintercept=2005, colour="grey20")+
  geom_vline(xintercept=2017, linetype="dotted", colour="grey20")+
  ggplot2::annotate("text", x=1960.5, y=220, label="(d)", size = 2.5, fontface=2, hjust=0)
S03.catch.dist.plot
...
abundance.Pre_1987 <- abundance.10_50 %>% 
  ...
  mutate(ColourGroup = ifelse(Year<=1985, "Pre-1987", ifelse(Scenario %in% c("Historical and current management") & Year>1985, "Historical and\ncurrent management", 
                                                             ifelse(Scenario %in% c("Temporal management only") & Year>1985, "Temporal\nmanagement only", 
                                                                    ifelse(Scenario %in% c("No spatial or temporal management"), "No NTZs or\ntemporal management", "NTZs and\ntemporal management")))))
...
abundance.10_50.plot <- abundance.10_50 %>% 
  ...
  geom_vline(xintercept=2005, colour="grey20")+
  geom_vline(xintercept=2017, linetype="dotted", colour="grey20")+
  ggplot2::annotate("text", x=1960, y=5000, label="(a)", size = 2.5, fontface=2)
...
line.recruit <- Whole_Pop_Ages %>% 
  ...
  geom_vline(xintercept=2005, colour="grey20")+
  geom_vline(xintercept=2017, linetype="dotted", colour="grey20")+
  ggplot2::annotate("text", x=1964.5, y=7.3, label="(a) <1 Year Old", size = 2.5, fontface=2)
line.recruit
...
line.sublegal <- Whole_Pop_Ages %>% 
  ...
  geom_vline(xintercept=2005, colour="grey20")+
  geom_vline(xintercept=2017, linetype="dotted", colour="grey20")+
  ggplot2::annotate("text", x=1967, y=6.5, label="(b) 1-3 Years Old", size = 2.5, fontface=2)
line.sublegal
...
line.legal <- Whole_Pop_Ages %>% 
  ...
  geom_vline(xintercept=2005, colour="grey20")+
  geom_vline(xintercept=2017, linetype="dotted", colour="grey20")+
  ggplot2::annotate("text", x=1965, y=15, label="(a) 3-10 Years Old", size = 2.5, fontface=2)
line.legal
...
line.largeLegal <- Whole_Pop_Ages %>% 
  ...
  geom_vline(xintercept=2005, colour="grey20")+
  geom_vline(xintercept=2017, linetype="dotted", colour="grey20") +
  ggplot2::annotate("text", x=1967, y=5.5, label="(b) 10-30 Years Old", size = 2.5, fontface=2)
line.largeLegal
